...
const CardEventsSkeleton = () => (
  <ContentLoader viewBox="0 0 660 475" height={475} width={660}>
...
CardEventsSkeleton.metadata = {
  name: 'DaniloWoz',
  github: 'danilowoz',
  description: 'CardEventsSkeleton',
  filename: 'CardEventsSkeleton',
}

export default CardEventsSkeleton